...
public class Mueve implements Runnable{
    ...
    public Mueve(TetrisFrame fr,int nivel){
        ...
        continuar=true;
        suspendFlag=true;
        frame.getPanelTiempo().iniciarCronometro();
    }
            ...
            while(continuar){
                ...
                if(!frame.getRejilla().seChoca(frame.getFigura(),Figura.ABAJO)){
                    ...
                    if(frame.getPanel()!=null)
                        ...
                        frame.getPanelTiempo().repaint();
                }
                else{
                    boolean valor=frame.getRejilla().copiaFiguraEnRejilla(frame.getFigura());
                    frame.getRejilla().eliminarFilasLlenas(frame);
                    if(frame.getPanel()!=null)
                        frame.getPanel().repaint();
                    if(!valor)
                        frame.renovar();
                        ...
                        frame.getPanelTiempo().pararCronometro();
                        continuar=false;
                    }
                }
            }// end while(continuar)
    ...
    synchronized public void suspender(){
        frame.getPanel().repaint();
        frame.getPanelTiempo().getHilo().suspend();
        suspendFlag=true;
    }
    ...
    public synchronized void reanudar(){
        ...
        frame.getPanelTiempo().getHilo().resume();
        suspendFlag = false;
        notify();
    }
    ...
    /**
     * Decrementa el delay para aumentar la dificultad
     */
    public void subeDificultad(int nivelExterno){
        delay =actualizaRetardo(nivelExterno);
    }
