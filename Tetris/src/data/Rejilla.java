...
public class Rejilla{
     ...
     */
    void eliminarFilasLlenas(TetrisFrame frame){
        ...
        while(hayfilasllenas){
            ...
            if(filallena>=0 && filallena<altura){
                frame.incrementarPuntos();
                frame.getPanelDatos().repaint();
                
                if ((frame.getPuntosInt()%25) == 0 && frame.getPuntosInt() != 0)
                    frame.incrementarNivel();
